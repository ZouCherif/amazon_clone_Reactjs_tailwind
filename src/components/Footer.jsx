  ...
  return (
    <footer>
        <div className="bg-[#232f3e] py-8 text-white">
            ...
            <div className="flex justify-around">
              {footerLinks.map((link)=>(
                <div className="xs:w-[165px] w-[140px]">
                  ...
                  <ul>
                    {link.links.map((item)=>(
                      <li className="xs:text-[14px] text-[12px] mb-1 cursor-pointer hover:underline">{item}</li>
                    ))}
                  </ul>
                </div>
              ))}
          ...
          <hr/>
          <div className='md:flex justify-end items-center md:w-[600px] w-[300px] mx-auto px-[30px] mt-6 text-gray-400 text-[14px]'>
            <img src={logo} className="w-[80px] xs:mr-auto mx-auto h-6 cursor-pointer mb-2 "/>
            <div className='flex cursor-pointer mr-2 border-[1px] p-2 items-center rounded-sm md:mb-0 mb-2 md:w-fit w-full' 
        ...
        <div className='bg-[#131921] text-white pb-8'>
          <div className='grid xs:grid-cols-7 grid-cols-5 gap-4 md:w-[70%] mx-auto p-6'>
